...
{
    [TestFixture]
    public class InLateDataMapperTests
    {
        [Test]
        public void TestsMapping()
        {
            var mapper = new InLateDataMapper();
            ...
            Assert.AreEqual(exceptionRules[0].ExceptionRule.InLate, result.Item2[0].Time);
            Assert.AreEqual(exceptionRules[1].ExceptionRule.InLate, result.Item2[1].Time);
            Assert.AreEqual(exceptionRules[2].ExceptionRule.InLate, result.Item2[2].Time);
